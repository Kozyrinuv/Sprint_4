...
//-------Конструктор class CheckFlow---------------------
    public CheckFlow (String name,String surname,String address,String telephone, String date) {
        this.name = name;
    ...
    //--------------------------------------------------------------------------------------
    // Метод для передачи(получения) тестовых данных в конструктор public CheckFlow(...)
...
//------------------------------------------------------------------------
   ...
   public void checkAllFlow() {
        ...
        PersonPage objPersonPage = new PersonPage(driver);
...
//============== 2 - Тестируем ЗАКАЗ по кнопке "Заказать"  в центре снизу страницы   ============================
        ...
        objHomePageScooter.clickOrderBottom();
